...
export default function AboutPage() {
  return (
    <>
      <div className="grid grid-cols-1  mb-16 mt-36 lg:grid-cols-2">
        <div className="col-span-1 lg:ms-44 mx-auto md:mx-16 mb-5 lg:mb-0 ">
          <h2 className="jomol text-5xl">About</h2>
          <div className="h-0.5 bg-black/50 mt-2 w-16"></div>
          <p className="roboto mt-2 w-8/12">
      ...
      <div className="w-11/12 mx-auto">
       ...
       <div className=" mb-16 mt-36 ">
        <div className="col-span-1   mx-auto mb-5 lg:mb-0 ">
          <h2 className="jomol lg:ms-44  md:mx-16 text-5xl">Leadership</h2>
          <div className="h-0.5 lg:ms-44  md:mx-16 bg-black/50 mt-2 w-16"></div>
